...
<div class="kr-page kr-page--boxed">
				<div class="row">
					<div class="col">
						...
						<section class="kr-tab">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="kr-tab__item nav-item">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="kr-tab__panel tab-pane fade show active" id="pills-tab1" role="tabpanel" aria-labelledby="pills-tab1-tab">
								...
								<div class="kr-tab__panel tab-pane fade" id="pills-tab2" role="tabpanel" aria-labelledby="pills-tab2-tab">
								...
								<div class="kr-tab__panel tab-pane fade" id="pills-tab3" role="tabpanel" aria-labelledby="pills-tab3-tab">
				...
				<div class="row">
					<div class="col">
						...
						<section class="kr-tab kr-tab--light">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								<li class="kr-tab__item nav-item">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="kr-tab__panel tab-pane fade show active" id="pills-tab11" role="tabpanel" aria-labelledby="pills-tab11-tab">
									<strong>Tab 1</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
								<div class="kr-tab__panel tab-pane fade" id="pills-tab22" role="tabpanel" aria-labelledby="pills-tab22-tab">
									<strong>Tab 2</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
								<div class="kr-tab__panel tab-pane fade" id="pills-tab33" role="tabpanel" aria-labelledby="pills-tab33-tab">
									<strong>Tab 3</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
							</div>	
						</section>				
				...
				<div class="row">
					<div class="col">
						...
						<section class="kr-tab kr-tab--bordered">
							...
							<div class="tab-content" id="pills-tabContent">
								<div class="kr-tab__panel tab-pane fade show active" id="pills-tab111" role="tabpanel" aria-labelledby="pills-tab111-tab">
									<strong>Tab 1</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
								<div class="kr-tab__panel tab-pane fade" id="pills-tab222" role="tabpanel" aria-labelledby="pills-tab222-tab">
									<strong>Tab 2</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
								<div class="kr-tab__panel tab-pane fade" id="pills-tab333" role="tabpanel" aria-labelledby="pills-tab333-tab">
									<strong>Tab 3</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis non, ipsam. Dolorum ad neque dignissimos reprehenderit dolore sint, consequuntur, repellendus laborum. Reprehenderit molestiae accusamus iure, autem iste dicta quibusdam sint.
								</div>
							</div>	
						</section>					
