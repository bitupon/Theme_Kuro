	...
	<div class="kr-page kr-page--boxed">
				<div class="row">
					...
					<div class="col">					
						...
						<div class="form-group">
							<select class="kr-custom-select kr-custom-select--light custom-select form-control">
								<option selected>Open this select menu</option>
								<option value="1">One</option>
								<option value="2">Two</option>
								<option value="3">Three</option>
						...
						<div class="form-group">
							<label class="kr-custom-file kr-custom-file--light custom-file">
								<input type="file" id="file2" class="custom-file-input">
								<span class="custom-file-control"></span>
							</label>
						&nbsp;</div>										
						...
						<div class="form-group">
							<div class="kr-input-group kr-input-group--light input-group">
								<span class="input-group-addon" id="basic-addon1">@</span>
								<input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
							</div>
						</div>
					...
					<div class="col">					
						...
						&nbsp;</div>
						<div class="form-group">
							<select class="kr-custom-select kr-custom-select--borderless  custom-select form-control">
								<option selected>Open this select menu</option>
								<option value="1">One</option>
								<option value="2">Two</option>
								<option value="3">Three</option>
						...
						<div class="form-group">
							<label class="kr-custom-file kr-custom-file--borderless custom-file">
								<input type="file" id="file2" class="custom-file-input">
								<span class="custom-file-control"></span>
							</label>
						&nbsp;</div>										
